...
import ProductEditionListV2, { defaultEditionsProps } from '../../atoms/product-edition-v2/list/ProductEditionListV2';
...
const n = createNamespace('ProductConfiguratorV2');
                ...
                {isEditionsVisible ? (
                    <div {...n('editions').props}>
                        <ProductEditionListV2
                            ...
                            hasAddons={!!addonProducts.items.length}
                            configuratorMode
