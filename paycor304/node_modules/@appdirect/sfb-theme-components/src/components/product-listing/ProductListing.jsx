...
import { scrollToTop } from '../../tools/interactivity/scroll';
...
import { ANCHOR_MAIN_CONTENT } from '../../constants/anchors';
            ...
            if (listingQuery !== null && listingQuery !== parsedQuery) {
                ...
                fetch(listingEndpoint)
                    ...
                    .then(
                        ...
                        // TODO: console.log for now, awaiting instructions on how to handle errors
